...
exports.create = (req, res) => {
    ...
    const product = new Product({
        ...
        star5Ratio :req.body.star5Ratio ||'',
        star4Ratio :req.body.star4Ratio ||'',
        star3Ratio :req.body.star3Ratio ||'',
        star2Ratio :req.body.star2Ratio ||'',
        star1Ratio :req.body.star1Ratio ||'',
        date: req.body.date || ''
    });
